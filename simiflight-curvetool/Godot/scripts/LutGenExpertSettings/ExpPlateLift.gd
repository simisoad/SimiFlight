...
@onready var plate_scale_sharp: SpinBox = %plate_scale_sharp
@onready var plate_scale_blunt: SpinBox = %plate_scale_blunt
@onready var plate_blunt_threshold: SpinBox = %plate_blunt_threshold
@onready var plate_thickness_damping_threshold: SpinBox = %plate_thickness_damping_threshold

# New Vars
@onready var plate_trans_width_deg: SpinBox = %plate_trans_width_deg
@onready var plate_deep_stall_start_deg: SpinBox = %plate_deep_stall_start_deg
@onready var plate_deep_stall_peak_deg: SpinBox = %plate_deep_stall_peak_deg
